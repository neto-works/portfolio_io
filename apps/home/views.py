...
class HomeView(View):
    ...
    def post(self, request):
        ...
        if form.is_valid():                        # Verifica se o formulário é válido, se é valido tem coisa dentro
            form.save()                            # Salva os dados no banco de dados
            return redirect('home')                # Redireciona para a página desejada após o envio do formulário
        else:
